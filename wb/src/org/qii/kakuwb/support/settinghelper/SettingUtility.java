package org.qii.kakuwb.support.settinghelper;
...
public class SettingUtility {
    ...
    /**
     * 如果第一次 创建新的sharepreferences 对象并且把值赋值为false
     * @return
     */
...
//
            case 3: return  R.style.AppTheme_Pink2;
            case 4: return  R.style.AppTheme_Green;
            case 5:return  R.style.AppTheme_Red;
            case 6:return  R.style.AppTheme_Blue;
...
//
    ...
    public static void switchToAnotherTheme() {
        ...
        switch (Integer.valueOf(value)) {
            case 1:
                SettingHelper.setEditor(getContext(), SettingActivity.THEME, "2");  //editor.commit
                break;
            case 2:
                break;
            case 3:
