package org.qii.kakuwb.ui.maintimeline;

import org.qii.kakuwb.R;
import org.qii.kakuwb.bean.AccountBean;
import org.qii.kakuwb.bean.GroupBean;
import org.qii.kakuwb.bean.MessageBean;
import org.qii.kakuwb.bean.MessageListBean;
import org.qii.kakuwb.bean.MessageReCmtCountBean;
import org.qii.kakuwb.bean.UserBean;
import org.qii.kakuwb.bean.android.AsyncTaskLoaderResult;
import org.qii.kakuwb.bean.android.MessageTimeLineData;
import org.qii.kakuwb.bean.android.TimeLinePosition;
import org.qii.kakuwb.dao.maintimeline.TimeLineReCmtCountDao;
import org.qii.kakuwb.othercomponent.WifiAutoDownloadPictureRunnable;
import org.qii.kakuwb.support.database.FriendsTimeLineDBTask;
import org.qii.kakuwb.support.debug.AppLogger;
import org.qii.kakuwb.support.error.WeiboException;
import org.qii.kakuwb.support.lib.HeaderListView;
import org.qii.kakuwb.support.lib.LogOnExceptionScheduledExecutor;
import org.qii.kakuwb.support.lib.MyAsyncTask;
import org.qii.kakuwb.support.lib.TopTipBar;
import org.qii.kakuwb.support.lib.VelocityListView;
import org.qii.kakuwb.support.settinghelper.SettingUtility;
import org.qii.kakuwb.support.utils.AppConfig;
import org.qii.kakuwb.support.utils.BundleArgsConstants;
import org.qii.kakuwb.support.utils.GlobalContext;
import org.qii.kakuwb.support.utils.Utility;
import org.qii.kakuwb.ui.adapter.AbstractAppListAdapter;
import org.qii.kakuwb.ui.adapter.StatusListAdapter;
import org.qii.kakuwb.ui.basefragment.AbstractMessageTimeLineFragment;
import org.qii.kakuwb.ui.browser.BrowserWeiboMsgActivity;
import org.qii.kakuwb.ui.loader.FriendsMsgLoader;
import org.qii.kakuwb.ui.main.LeftMenuFragment;
import org.qii.kakuwb.ui.main.MainTimeLineActivity;
import org.qii.kakuwb.ui.send.WriteWeiboActivity;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.yellow1:  //粉色
                ...
                break;
            case R.id.yellow2 :  //绿色
                ((MainTimeLineActivity) getActivity()).saveNavigationPositionToDB();
                SharedPreferences.Editor editor2=PreferenceManager.getDefaultSharedPreferences(getActivity()).edit();
                editor2.putString("theme","4");
                editor2.commit();
                ((MainTimeLineActivity) getActivity()).reload();
                break;
            case R.id.yellow3:  //玫瑰红
                ((MainTimeLineActivity) getActivity()).saveNavigationPositionToDB();
                SharedPreferences.Editor editor3=PreferenceManager.getDefaultSharedPreferences(getActivity()).edit();
                editor3.putString("theme","5");
                editor3.commit();
                ((MainTimeLineActivity) getActivity()).reload();
                break;
            case R.id.yellow4:   //天空蓝
                ((MainTimeLineActivity) getActivity()).saveNavigationPositionToDB();
                SharedPreferences.Editor editor4=PreferenceManager.getDefaultSharedPreferences(getActivity()).edit();
                editor4.putString("theme","6");
                editor4.commit();
                ((MainTimeLineActivity) getActivity()).reload();
                break;
            case R.id.yellow5: //gray
                ((MainTimeLineActivity) getActivity()).saveNavigationPositionToDB();
                SharedPreferences.Editor editor5=PreferenceManager.getDefaultSharedPreferences(getActivity()).edit();
                editor5.putString("theme","7");
                editor5.commit();
                ((MainTimeLineActivity) getActivity()).reload();
                break;
