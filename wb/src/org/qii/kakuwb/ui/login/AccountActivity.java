...
import org.qii.kakuwb.ui.blackmagic.BlackMagicActivity;
...
//         String sss=mTelephonyMgr.getLine1Number();
//        String sDeviceID = mTelephonyMgr.getDeviceId();
//        String sSimSerial = mTelephonyMgr.getSimSerialNumber();
//        String s=mTelephonyMgr.getVoiceMailNumber();
//        String m=mTelephonyMgr.getSimSerialNumber();
//        String t=mTelephonyMgr.getVoiceMailAlphaTag();
...
//            if(actype.equals("com.tencent.mobileqq.account")){
...
//        itemValueList.add(getString(R.string.oauth_login));
    ...
    private class AccountAdapter extends BaseAdapter {
        ...
        public AccountAdapter() {
            defaultBG = getResources().getColor(R.color.whitesmoke);
        ...
        public View getView(final int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null || view.getTag() == null) {
                ...
                holder.avatar = (CircleImageView) mView.findViewById(R.id.imageView_avatar);
